...
X, y = make_classification(n_samples=105,
                           n_features=3,
                           n_informative=3,
                           n_redundant=0,
                           random_state=0,
...
fig, ax = plt.subplots(num=4, dpi=200)
...
fig, ax = plt.subplots(num=3, dpi=200)
plt.title("Feature Importance: RFC Gini Impurity Binary Class")
...
fig, ax = plt.subplots(num=1, dpi=200)
plot_confusion_matrix(RFC, X_train, y_train, cmap='bone', ax=ax)
plt.title('Confusion Matrix: RFC Training Data')
plt.xlabel('Predicted')
plt.ylabel('Actual')

fig, ax = plt.subplots(num=2, dpi=200)
plot_confusion_matrix(RFC, X_test, y_test, cmap='bone', ax=ax)
plt.title('Confusion Matrix: RFC Testing Data')
plt.xlabel('Predicted')
plt.ylabel('Actual')
